...
$.richFilemanagerPlugin = function(element, pluginOptions)
{
	...
	var localize = function() {
		var langCode = _url_.param('lang');
		var langPath = fm.settings.baseUrl + '/locale/languages/';
	...
	var includeAssets = function(callback) {
        ...
        if(config.customScrollbar.enabled) {
            primary.push('/js/repository/custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css');
            primary.push('/js/repository/custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js');
        }
		...
		if(config.viewer.editable.enabled) {
            ...
            if (editorTheme && editorTheme !== 'default') {
                secondary.push('/js/repository/CodeMirror/theme/' + editorTheme + '.css');
            }
            secondary.push('/js/repository/CodeMirror/lib/codemirror.css');
            secondary.push('/js/repository/CodeMirror/lib/codemirror.js');
            secondary.push('/js/repository/CodeMirror/addon/selection/active-line.js');
            secondary.push('/js/repository/CodeMirror/addon/display/fullscreen.css');
            secondary.push('/js/repository/CodeMirror/addon/display/fullscreen.js');
		}

		// Load Markdown-it, if enabled. For .md to HTML rendering:
		if(config.viewer.markdownRenderer.enabled) {
            secondary.push('/css/repository/fm-markdown.css');
            secondary.push('/js/repository/markdown-it/markdown-it.min.js');
            secondary.push('/js/repository/markdown-it/default.min.css');
            secondary.push('/js/repository/markdown-it/highlight.min.js');
            secondary.push('/js/repository/markdown-it/markdown-it-footnote.min.js');
            secondary.push('/js/repository/markdown-it/markdown-it-replace-link.min.js');
		}

		if(!config.options.browseOnly) {
			// Loading jquery file upload library
            secondary.push('/js/repository/jQuery-File-Upload/js/vendor/jquery.ui.widget.js');
            secondary.push('/js/repository/jQuery-File-Upload/js/canvas-to-blob.min.js');
            secondary.push('/js/repository/jQuery-File-Upload/js/load-image.all.min.js');
            secondary.push('/js/repository/jQuery-File-Upload/js/jquery.iframe-transport.js');
            secondary.push('/js/repository/jQuery-File-Upload/js/jquery.fileupload.js');
            secondary.push('/js/repository/jQuery-File-Upload/js/jquery.fileupload-process.js');
            secondary.push('/js/repository/jQuery-File-Upload/js/jquery.fileupload-image.js');
            secondary.push('/js/repository/jQuery-File-Upload/js/jquery.fileupload-validate.js');

			if(config.upload.multiple) {
                secondary.push('/js/repository/jQuery-File-Upload/css/dropzone.css');
			}
		}
		...
		var PreviewModel = function() {
            ...
            this.applyObject = function(resourceObject) {
                ...
                if(isOpenDocFile(filename) && config.viewer.opendoc.enabled === true) {
                    ...
                    viewerObject.url = fm.settings.baseUrl + '/js/repository/ViewerJS/index.html#' + createPreviewUrl(resourceObject, true);
                    viewerObject.options = {
            ...
            ZeroClipboard.config({swfPath: fm.settings.baseUrl + '/js/repository/zeroclipboard/dist/ZeroClipboard.swf'});
        ...
        var EditorModel = function() {
            ...
            function includeAssets(extension) {
                ...
                if (config.viewer.editable.codeHighlight) {
                    if (extension === 'js') {
                        assets.push('/js/repository/CodeMirror/mode/javascript/javascript.js');
                        currentMode = 'javascript';
                    }
                    if (extension === 'css') {
                        assets.push('/js/repository/CodeMirror/mode/css/css.js');
                        currentMode = 'css';
                    }
                    if (extension === 'html') {
                        assets.push('/js/repository/CodeMirror/mode/xml/xml.js');
                    ...
                    if (extension === 'php') {
                        assets.push('/js/repository/CodeMirror/mode/htmlmixed/htmlmixed.js');
                        assets.push('/js/repository/CodeMirror/mode/xml/xml.js');
                        assets.push('/js/repository/CodeMirror/mode/javascript/javascript.js');
                        assets.push('/js/repository/CodeMirror/mode/css/css.js');
                        assets.push('/js/repository/CodeMirror/mode/clike/clike.js');
                        assets.push('/js/repository/CodeMirror/mode/php/php.js');
                    ...
                    if (extension === 'sql') {
                        assets.push('/js/repository/CodeMirror/mode/sql/sql.js');
                        currentMode = 'text/x-mysql';
                    }
                    if (extension === 'md') {
                        assets.push('/js/repository/CodeMirror/addon/mode/overlay.js');
                        assets.push('/js/repository/CodeMirror/mode/xml/xml.js');
                        assets.push('/js/repository/CodeMirror/mode/markdown/markdown.js');
                        assets.push('/js/repository/CodeMirror/mode/gfm/gfm.js');
                        assets.push('/js/repository/CodeMirror/mode/javascript/javascript.js');
                        assets.push('/js/repository/CodeMirror/mode/css/css.js');
                        assets.push('/js/repository/CodeMirror/mode/htmlmixed/htmlmixed.js');
                        assets.push('/js/repository/CodeMirror/mode/clike/clike.js');
                        assets.push('/js/repository/CodeMirror/mode/shell/shell.js');
                        assets.push('/js/repository/CodeMirror/mode/meta.js');
                        currentMode = 'gfm';
                    }
                    if (extension === 'sh') {
                        assets.push('/js/repository/CodeMirror/addon/mode/overlay.js');
	...
	var loadTemplate = function(id, data) {
		return $.ajax({
			type: 'GET',
			url: fm.settings.baseUrl + '/js/repository/templates/' + id + '.html',
			error: handleAjaxError
		});
	};
					...
					.on('fileuploadadd', function(e, data) {
						...
						$.each(data.files, function (index, file) {
							...
							var $template = $(tmpl('tmpl-upload-item', {
								file: file,
								lang: lg,
								imagesPath: fm.settings.baseUrl + '/js/repository/jQuery-File-Upload/img'
							}));
