...
<head>
    ...
    <title>Repository FoTRRIS Platform</title>
    <link rel="stylesheet" type="text/css" href="css/repository/reset.css"/>
    <link rel="stylesheet" type="text/css" href="css/repository/filemanager.css"/>
    <link rel="stylesheet" type="text/css" href="js/repository/jquery.contextmenu/dist/jquery.contextMenu.min.css"/>
    <link rel="stylesheet" type="text/css" href="js/repository/custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css"/>
    <link rel="stylesheet" type="text/css" href="js/repository/alertify.js/dist/css/alertify.css">

    <!--[if IE 9]>
    <link rel="stylesheet" type="text/css" href="css/repository/ie9.css"/>
    <![endif]-->
    ...
    <style type="text/css">
        .fm-container .fm-loading-wrap {
            ...
            left: 0;
            display: block;
            background: white url(./img/repository/spinner.gif) no-repeat center center;
            z-index: 999;
        }
    </style>
...
?>
    <div class="fm-container">
                ...
                <div class="fm-wrapper">
                    <div class="fm-header">
                        ...
                        <div class="buttons-panel">
                            ...
                            <div class="button-group clipboards-controls">
                                <button class="btn-clipboard-copy no-label" type="button"
                                        data-bind="click: clipboardModel.copy, visible: clipboardModel.hasCapability('copy'), attr: {title: localizeGUI() ? lg().clipboard_copy : null}">
                                    <span>&nbsp;</span></button>
                                <button class="btn-clipboard-cut no-label" type="button"
                                        data-bind="click: clipboardModel.cut, visible: clipboardModel.hasCapability('cut'), attr: {title: localizeGUI() ? lg().clipboard_cut : null}">
                                    <span>&nbsp;</span></button>
                                <button class="btn-clipboard-paste no-label" type="button"
                                        data-bind="click: clipboardModel.paste, visible: clipboardModel.hasCapability('paste'), attr: {title: localizeGUI() ? lg().clipboard_paste_full : null}">
                                    <span>&nbsp;</span></button>
                                <button class="btn-clipboard-clear no-label" type="button"
                                        data-bind="click: clipboardModel.clear, visible: clipboardModel.hasCapability('clear'), attr: {title: localizeGUI() ? lg().clipboard_clear_full : null}">
                                    <span>&nbsp;</span></button>
                            </div>
                            ...
                            <div class="button-group navigate-controls">
                                <button class="btn-level-up no-label" type="button"
                                        data-bind="click: headerModel.goParent, attr: {title: localizeGUI() ? lg().go_level_up : null}">
                                    <span>&nbsp;</span>
                                </button>
                                <button class="btn-home-folder no-label" type="button"
                                        data-bind="click: headerModel.goHome, attr: {title: localizeGUI() ? lg().go_home : null}">
                                    <span>&nbsp;</span>
                                </button>
                            </div>
                            <!-- ko if: !browseOnly() -->
                            ...
                            <div class="button-group viewmode-controls">
                                <button class="btn-grid-mode no-label" type="button"
                                        data-bind="click: headerModel.displayGrid, attr: {title: localizeGUI() ? lg().grid_view : null}, css: {active: viewMode() === 'grid'}">
                                    <span>&nbsp;</span>
                                </button>
                                <button class="btn-list-mode no-label" type="button"
                                        data-bind="click: headerModel.displayList, attr: {title: localizeGUI() ? lg().list_view : null}, css: {active: viewMode() === 'list'}">
                                    <span>&nbsp;</span>
                                </button>
                            </div>
                            <!-- ko if: headerModel.closeButton() -->
                            <div class="button-group">
                                <button class="btn-close-window no-label" type="button"
                                        data-bind="click: headerModel.closeButtonOnClick, attr: {title: localizeGUI() ? lg().close : null}">
                                    <span>&nbsp;</span>
                                </button>
                            </div>
                            <!-- /ko -->
                        ...
                        <div class="fm-fileinfo">
                            ...
                            <div class="view-items-wrapper" data-bind="visible: !loadingView() && !previewFile()">
                                ...
                                <div class="view-items">
                                    <ul class="grid"
                                        data-bind="visible: viewMode() === 'grid', foreach: {data: itemsModel.objects, as: 'koItem'}">
                                        <!-- ko if: koItem.rdo.type === "parent" -->
                                        <li class="directory-parent"
                                            data-bind="event: {click: koItem.open, dblclick: koItem.open}, droppableView: koItem, css: koItem.itemClass()"
                                    ...
                                    <table class="list" data-bind="visible: viewMode() === 'list'">
                                        ...
                                        <!-- ko if: koItem.rdo.type !== "parent" -->
                                        <tr data-bind="event: {click: koItem.open, dblclick: koItem.open, mousedown: koItem.mouseDown}, droppableView: koItem, attr: {title: koItem.title()}, css: koItem.itemClass()"
                                            oncontextmenu="return false;">
                                            <td>
                                ...
                                <div class="fm-preview" data-bind="with: previewModel">
                                    <div class="fm-preview-toolbar">
                                        <form id="fm-js-preview-toolbar">
                                            <button class="btn-file-preview-close" type="button"
                                                    data-bind="event: {click: function(data, event) {$root.headerModel.goParent()}}">
                                                <span data-bind="text: $root.lg().parentfolder"></span>
                                            </button>
                                            <!-- ko if: buttonVisibility('select') -->
                                            <button class="btn-file-select" type="button"
                                            ...
                                            <button class="btn-file-download" type="button"
                                            ...
                                            <button class="btn-file-rename" type="button"
                                            ...
                                            <button class="btn-file-move" type="button"
                                            ...
                                            <button class="btn-file-delete" type="button"
                                            ...
                                            <button class="btn-file-replace" type="button"
                                                    data-bind="event: {click: function(data, event) {bindToolbar('replace')}}">
                    ...
                    <script type="text/javascript" src="js/repository/jquery-1.11.3.min.js"></script>
                    <!-- drag&drop + selectable build (includes customizations for RichFilemanager) -->
                    <script type="text/javascript" src="js/repository/jquery-ui/jquery-ui.min.js"></script>
                    <script type="text/javascript" src="js/repository/jquery-browser.js"></script>
                    <script type="text/javascript" src="js/repository/knockout-3.4.0.js"></script>
                    <script type="text/javascript" src="js/repository/jquery-mousewheel/jquery.mousewheel.min.js"></script>
                    <script type="text/javascript" src="js/repository/jquery.splitter/dist/jquery-splitter.js"></script>
                    <script type="text/javascript" src="js/repository/jquery.contextmenu/dist/jquery.contextMenu.min.js"></script>
                    <script type="text/javascript" src="js/repository/alertify.js/dist/js/alertify.js"></script>
                    <script type="text/javascript" src="js/repository/zeroclipboard/dist/ZeroClipboard.js"></script>
                    <script type="text/javascript" src="js/repository/jquery.fileDownload/jquery.fileDownload.min.js"></script>
                    <script type="text/javascript" src="js/repository/javascript-templates/js/tmpl.min.js"></script>
                    <script type="text/javascript" src="js/repository/toast/lib/toast.min.js"></script>
                    <script type="text/javascript" src="js/repository/purl/purl.min.js"></script>
                    <!-- Load filemanager script -->
                    <script type="text/javascript" src="js/repository/filemanager.js"></script>
