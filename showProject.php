        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                            ...
                            <li class="span4" data-color="color">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <p><?php echo _("Hub"); ?>: <?php echo $project->getNameArena(); ?></p>
                                        <p class="keywords"><?php echo _("Keywords"); ?>:
                                            <?php $i = 1;
                                        ...
                                        <p>
                                            <button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#myModal<?php echo $project->getId(); ?>"><?php echo _("Description"); ?></button>
                                            ...
                                            if (login_check($mysqli) == true) {
                                                if (isUserToJoin($mysqli, $project->getId(), $_SESSION['id_user']) == 'F') { ?>
                                                    <a href="<?php echo $helper->url("project", "join"); ?>&id_project=<?php echo $project->getId(); ?>&id_user=<?php echo htmlentities($_SESSION['id_user']); ?>&nam=<?php echo htmlentities($_SESSION['username']); ?>"
                                                       class="btn btn-primary btn-md"><?php echo _("Join"); ?></a>
                                                <?php }
                                            }?>
                                        </p>
                                        <!-- Modal -->
                    ...
                    <p>
                        <cite>
                            <i> <?php if (login_check($mysqli) == true) { ?>
